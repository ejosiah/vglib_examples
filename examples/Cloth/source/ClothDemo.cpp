...
void ClothDemo::loadModel() {
    ...
    //    phong::load(R"(C:\Users\joebh\OneDrive\media\models\Nissan FairladyZ 2009\basemeshobj.obj)", device, descriptorPool, model, info, true, 30);
    phong::load(R"(C:\Users\joebh\OneDrive\media\models\werewolf.obj)", device, descriptorPool, model, info, true, 3);
  //  phong::load(R"(C:\Users\joebh\OneDrive\media\models\Lucy-statue\metallic-lucy-statue-stanford-scan.obj)",device, descriptorPool, model, info, true, 40);
