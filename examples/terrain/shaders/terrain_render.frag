...
layout(location = 5) flat in int isVisible;
layout(location = 6) noperspective in vec3 distance;
...
//
//    if(debugOn()) {
//        debugPrintfEXT("N: [%f, %f, %f], V: [%f, %f, %f], N.V: %f\n", N.x, N.y, N.z, V.x, V.y, V.z, dot(N, V));
//    }
}