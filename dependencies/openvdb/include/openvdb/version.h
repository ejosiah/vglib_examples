...
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_STRING "12.0.1"
...
/// (although the two are usually the same).
/// @hideinitializer
#define OPENVDB_LIBRARY_ABI_VERSION_STRING "12.0.1abi12"

/// @brief Library version number as a packed integer ("%02x%02x%04x", major, minor, patch)
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_NUMBER 201326593
...
#else
    #define OPENVDB_VERSION_NAME v12_0abi12
#endif
